...
import 'package:wire_ropes/ui/wire_types/sling/sling_viewmodel.dart';

class SlingView extends StatelessWidget {

  final Function(Sling) getDate;

  const SlingView({Key? key, required this.getDate}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<SlingViewModel>.reactive(
        ...
        viewModelBuilder: () => SlingViewModel());
  }
}
